...
import net.ninjacat.omg.reflect.*;
...
public final class AsmPatternCompiler<T> implements PropertyPatternCompiler<T> {
    ...
    private <P> PropertyPattern<T> buildEqPattern(final PropertyCondition<P> condition) {
        ...
        return Match(property.getWidenedType()).of(
                ...
                Case($(AsmPatternCompiler::isEnum), enumProp -> new EnumEqPattern<>(property, toStringOrNull(condition.getValue())))
        );
    }
    ...
    private <P> PropertyPattern<T> buildNeqPattern(final PropertyCondition<P> condition) {
        ...
        return Match(property.getWidenedType()).of(
                ...
                Case($(AsmPatternCompiler::isEnum), enumProp -> new EnumNeqPattern<>(property, toStringOrNull(condition.getValue())))
        );
    }
    ...
    private PropertyPattern<T> buildObjectPattern(final ObjectCondition condition) {
        ...
        if (isBasicType(property.getWidenedType())) {
            ...
            return new ObjectPattern<T>(property,
                    Patterns.compile(condition.getValue(), AsmPatternCompiler.forClass(property.getType())));
