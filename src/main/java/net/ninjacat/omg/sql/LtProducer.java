...
public class LtProducer implements SqlConditionProducer<OmSqlParser.ConditionContext> {
    ...
    public void create(final Conditions.LogicalConditionBuilder builder, final String property, final OmSqlParser.ConditionContext value) {
        builder.property(property).lt(toJavaType(value.literal_value().getText()));
    }
}
